...
import { ServiceDeleteChannels } from '@/services/channels';
...
function AlertDialog( {open, setOpen, planKey}: {open: boolean, setOpen: any, planKey: string} ) {
  ...
  const handleDelete = async () =>{
    try {
      const res = await ServiceDeleteChannels(planKey)
      enqueueSnackbar('Channel deleted succesful!', { variant: 'success' });
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            You are about to delete {planKey} channel, are you sure?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
